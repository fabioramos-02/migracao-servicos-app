...
var W = (r, t, e) => ct(r, typeof t != "symbol" ? t + "" : t, e);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const N = globalThis, B = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, st = Symbol(), V = /* @__PURE__ */ new WeakMap();
let dt = class {
  constructor(t, e, s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: $t, defineProperty: _t, getOwnPropertyDescriptor: ft, getOwnPropertyNames: At, getOwnPropertySymbols: mt, getPrototypeOf: gt } = Object, f = globalThis, Z = f.trustedTypes, yt = Z ? Z.emptyScript : "", k = f.reactiveElementPolyfillSupport, w = (r, t) => r, j = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? yt : null;
      break;
  ...
  return e;
} }, it = (r, t) => !$t(r, t), F = { attribute: !0, type: String, converter: j, reflect: !1, useDefault: !1, hasChanged: it };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, G = (r) => r, R = C.trustedTypes, J = R ? R.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, rt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, nt = "?" + _, vt = `<${nt}>`, y = document, x = () => y.createComment(""), M = (r) => r === null || typeof r != "object" && typeof r != "function", I = Array.isArray, Et = (r) => I(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", D = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, K = /-->/g, Q = />/g, A = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X = /'/g, Y = /"/g, ot = /^(?:script|style|textarea|title)$/i, bt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), St = bt(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), tt = /* @__PURE__ */ new WeakMap(), m = y.createTreeWalker(y, 129);
function ht(r, t) {
...
const wt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === S ? p[1] === "!--" ? o = K : p[1] !== void 0 ? o = Q : p[2] !== void 0 ? (ot.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = A) : p[3] !== void 0 && (o = A) : o === A ? p[0] === ">" ? (o = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? A : p[3] === '"' ? Y : X) : o === Y || o === X ? o = A : o === K || o === Q ? o = S : (o = A, i = void 0);
    const $ = o === A && r[a + 1].startsWith("/>") ? " " : "";
    n += o === S ? h + vt : l >= 0 ? (s.push(c), h.slice(0, l) + rt + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(rt)) {
          ...
          h.push({ type: 1, index: n, name: H[2], strings: $, ctor: H[1] === "." ? Pt : H[1] === "?" ? xt : H[1] === "@" ? Mt : T }), i.removeAttribute(l);
...
class Ct {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new O(n, n.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (c = new Ut(n, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class O {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), M(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Et(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class T {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = b(this, t, e, 0), o = !M(t) || t !== this._$AH && t !== E, o && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = b(this, a[s + h], e, h), c === E && (c = this._$AH[h]), o || (o = !M(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
L == null || L(U, O), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.3");
const Ot = (r, t, e) => {
...
class at extends P {
  ...
  constructor() {
    super(), this.secretaria = `Governo de
Mato Grosso do Sul`, this.version = "v2.0.0", this.forceMobile = !1, this.open = !1;
  }
  _toggle() {
    this.open = !this.open;
  }
  render() {
    const t = this.forceMobile ? "ds-header is-mobile" : "ds-header";
    return St`
      <header class="${t}" role="banner">
        <div class="brand">
...
customElements.get("ms-header") || customElements.define("ms-header", at);
export {
  at as MsHeader
};
